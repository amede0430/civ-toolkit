...
import cha from "assets/images/cha2.avif";
  ...
  return (
    <Box>
      ...
      >
        ...
        >cv</MKBox>
        <Typography variant="h4">Plan Detail Page</Typography>
        <Box>
      ...
      <Grid container spacing={2} sx={{ padding: "20px" }}>
        <Grid item xs={12} md={6}>
          <Box
            component="img"
            src="https://example.com/plan-image.jpg"
            alt="Image du plan"
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ padding: "20px" }}>
            ...
            <Button variant="contained" color="primary" fullWidth onClick={handleDownload} sx={{ mb: 2 }}>
              Télécharger
            </Button>
            <Button variant="contained" color="secondary" fullWidth onClick={handleOrder}>
              Commander
            </Button>
